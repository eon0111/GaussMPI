 ...
 * @brief Implementación distribuida (MPI) y paralelizada (OMP) del algoritmo de Gauss-Jordan para
...
#pragma omp parallel for private (j, ratio, count)
...
#pragma omp parallel for reduction(+:mi_resultado)
